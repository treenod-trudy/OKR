...
function _GoogleSignIn(auth_id) {
 google.accounts.id.initialize({
  client_id: UTF8ToString(auth_id),
...
function _GoogleSignOut() {
 google.accounts.id.disableAutoSelect();
 SendMessage("GAuthWebListener", "OnGoogleSingOut");
}
